...
//	type=rtp_session_get_recv_payload_type(d->session);
//	printf("pt tepe is is %d!!!!!!!!!!!\n",type);
	...
	while ((m = rtp_session_recvm_with_ts(d->session, timestamp)) != NULL) {//jimmy ++  rtp get  mblk_t data no rtp head
