...
void setup_media_streams(MediastreamDatas* args) {
	...
	if (args->pt->type!=PAYLOAD_VIDEO){
		...
		audio_stream_start_full(args->audio,args->profile,args->ip,args->remoteport,args->ip,args->remoteport+1, args->payload, args->jitter,args->infile,args->outfile, args->outfile==NULL ? play : NULL ,args->infile==NULL ? capt : NULL,FALSE);
