...
/**
 * Create a new sound capture card object.
 *
 * @param desc   A sound capture card description object.
 *
 * Returns: MSSndCard if successfull, NULL otherwise.
 */
MS2_PUBLIC MSSndCard * ms_snd_card_new_capture(MSSndCardDesc *desc);

/**
 * Create a new sound playback card object.
 *
 * @param desc   A sound playback card description object.
 *
 * Returns: MSSndCard if successfull, NULL otherwise.
 */
MS2_PUBLIC MSSndCard * ms_snd_card_new_playback(MSSndCardDesc *desc);
...
MS2_PUBLIC MSSndCard * ms_snd_card_new_with_name_capture(MSSndCardDesc *desc,const char* name);

/**
 * Create a new sound playback card object.
 *
 * @param desc   A sound card playback description object.
 * @param card mame
 *
 * Returns: MSSndCard if successfull, NULL otherwise.
 */
	
MS2_PUBLIC MSSndCard * ms_snd_card_new_with_name_playback(MSSndCardDesc *desc,const char* name);
