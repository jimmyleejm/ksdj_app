...
/*
 * Enable Keypad functions for answer and call sip
 */
#define	__ENABLE_KEYPAD__
#define __ENABLE_VKEYPAD__	//virtual keypad for MiniGUI
/**************************************************************************
 *
 *  Types
 *
...
extern char *sip_terminate_call;
extern char *sip_answer_call;
extern char *sip_addrurl_call;
#endif
#if defined(__ENABLE_KEYPAD__)
extern int init_keydevice(void);
extern int keypads_thread_create(void);
extern int keypads_thread_destroy(void);
#endif
#if defined(__ENABLE_VKEYPAD__)
extern int init_vkeydevice(void);
extern int vkeypads_thread_create(void);
extern int vkeypads_thread_destroy(void);
#endif
