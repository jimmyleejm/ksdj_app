...
static void _linphone_chat_room_send_message(LinphoneChatRoom *cr, LinphoneChatMessage* msg){
	...
	printf("_linphone_chat_room_send_message\n");
...
void linphone_chat_room_send_message(LinphoneChatRoom *cr, const char *msg) {
	printf("linphone_chat_room_send_message\n");
...
void linphone_core_message_received(LinphoneCore *lc, SalOp *op, const SalMessage *sal_msg){
	...
	printf("linphone_core_message_received!!!!!!\n");
	printf("sal_msg->from is %s!\n",sal_msg->from);
	addr=linphone_address_new(sal_msg->from);
	linphone_address_clean(addr);
	cr=linphone_core_get_chat_room(lc,addr);
	cleanfrom=linphone_address_as_string(addr);
	/*
	printf("cleanfrom is %s!\n",cleanfrom);
	if(cr->peer_url!=NULL)
		{
	from=linphone_address_as_string(cr->peer_url);
	printf("cr->peer_url is %s!\n",linphone_address_as_string(cr->peer_url));
		}
	else
		{
		printf("cr->peer_url is null\n");
		}
	*/
	...
	//jimmy 
	//linphone_chat_message_set_from(msg, cr->peer_url);// addr jimmy chage for door alarm get a error ip address
	linphone_chat_message_set_from(msg, addr);
	//printf("msg->from is %s!\n",linphone_address_as_string(msg->from));
	{
		LinphoneAddress *to;
...
LinphoneChatMessage* linphone_chat_room_create_message(LinphoneChatRoom *cr, const char* message) {
	printf("linphone_chat_room_create_message\n");
