...
//jimmy +++ spi build and send refer
...
//jimmy ++ process_event from route
static bool_t process_event(Sal *sal, eXosip_event_t *ev){
	...
	switch(ev->type){
		...
		case EXOSIP_CALL_CANCELLED:
			printf("CALL_CLOSED or CANCELLED\n");
